-- Conventions:
-- "rel_" prefix denotes a JOIN table, e.g., "rel_users_groups" relates "users" to "groups"
-- "log_" prefix denotes a versioning table
-- id columns are the same throughout the schema in order to use JOIN...USING()
-- NOTE: FULLTEXT indices default min word length is 4, meaning "eye" or "PSU" won't match
-- ----------------------------------------------------------------------------
-- Virtualslide tables
-- ----------------------------------------------------------------------------
